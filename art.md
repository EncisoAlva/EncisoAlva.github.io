...
My Instagram page, [BézierSpirographsEveryDay](https://www.instagram.com/Bezierspirographseveryday?igsh=MWR2NXBtcGdhNWxyNg==), has a great collection of those figures.
...
Consider a circle $\mathcal{W}$ with center at $O_\mathcal{W}$ and radius $R_\mathcal{W}$. The circle $\mathcal{W}$ is *rolling* over a line $\mathcal{L}$. A **cycloid** can be described as the curves generated by a point $\mathbf{M}$ located at the circumference of $\mathcal{W}$. 

![Construction of a cycloid.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig01.gif?raw=true)
...
| :---: | :---: |
|  ![Epicycloid with integer ratio 3.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig02b.gif?raw=true) |  ![Epicycloid with integer ratio 5.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig02c.gif?raw=true) |

If the ratio $k = R_\mathcal{W}/R_\mathcal{C}$ is rational, then the number of cusps will be $\tau$, the smallest integer so that $\tau/k$ is an integer. Additionally, the epicycloid will take $\tau$ *rotations* to be completed. A line normal to the circle will intersect the epicycloid exactly $\tau$ times.

| :---: | :---: |
|  ![Epicycloid with rational ratio 5/2.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig03b.gif?raw=true) |  ![Epicycloid with rational ratio 7/3.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig03c.gif?raw=true) |
...
**Spoiler:** All these observations are conserved if the circle $\mathcal{C}$ is replaced by $\mathcal{B}$, an arbitrary once-differentiable closed curve of finite length.
Although the ratio between radii should be replaced by a ratio between perimeters $k = P_\mathcal{W}/P_\mathcal{B}$. After all, an arbitrary once-differentiable closed curve of finite length may not have a radius, but it will certainly have a well-defined perimeter.

| :---: | :---: |
|  ![Generalized epicycloid with rational ratio 5/2.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig04b.gif?raw=true) |  ![Generalized epicycloid with rational ratio 7/3.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig04c.gif?raw=true) |
...
| :---: | :---: |
|  ![Hypercycloid with integer ratio 5.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig05b.gif?raw=true) |  ![Hypercycloid with rational ratio 5/3.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig05c.gif?raw=true) |
...
![Curtate cycloid.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig07a.gif?raw=true)
![Prolate cycloid.](https://github.com/EncisoAlva/EncisoAlva.github.io/blob/main/img/art_gif/fig07b.gif?raw=true)
...
For example, [this video](https://www.youtube.com/watch?v=iajOVo6gFDU) from a manufacturer shows the use of these rings. The interested reader may also refer to [this tool](https://glagolj.github.io/gg-blog/tools/roulette_plot.html) to simulate the use of one single ring.
